...
<body>
	<table border="1" width="599">
		...
		<s:if test="#request.readerId==null">
			<td colspan="2">
				图书信息&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;ISBN<s:textfield name="lend.ISBN" size="15" disabled="true"></s:textfield>
				&nbsp;&nbsp;&nbsp;&nbsp; 图书ID<s:textfield name="lend.bookId" size="15" disabled="true"></s:textfield>
				<s:submit value="借书" disabled="true"/>
			</td>
		</s:if>
		<s:else>
			<td colspan="2">
				图书信息&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;ISBN<s:textfield name="lend.ISBN" size="15"></s:textfield>
