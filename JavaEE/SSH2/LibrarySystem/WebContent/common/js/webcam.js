    ...
    var Webcam = {
        ...
        exifOrientation: function(e) {
            ...
            while (a < e.byteLength) {
                ...
                if (i == 225) {
                    ...
                    for (var c = 0; c < l; c++) { var d = h + c * 12 + 2; if (t.getUint16(d, !r) == 274) { var f = t.getUint16(d + 2, !r); var m = t.getUint32(d + 4, !r); if (f != 3 && m != 1) { console.log("Invalid EXIF orientation value type (" + f + ") or count (" + m + ")"); return 0 } var p = t.getUint16(d + 8, !r); if (p < 1 || p > 8) { console.log("Invalid EXIF orientation value (" + p + ")"); return 0 } return p } }
            ...
            if (this.userMedia) {
                ...
                f.addEventListener("change", function(e) {
                    if (e.target.files.length > 0 && e.target.files[0].type.indexOf("image/") == 0) {
                        ...
                        i.addEventListener("load", function(e) { var i = h.exifOrientation(e.target.result); if (i > 1) { h.fixOrientation(t, i, a) } else { a.src = t } }, false);
                ...
                l.addEventListener("click", function(e) {
                    if (m.user_callback) { h.snap(m.user_callback, m.user_canvas) } else {
        ...
        detectFlash: function() {
            var t = "Shockwave Flash",
                ...
                r = navigator,
                o = false;
            if (typeof r.plugins !== "undefined" && typeof r.plugins[t] === "object") { var n = r.plugins[t].description; if (n && (typeof r.mimeTypes !== "undefined" && r.mimeTypes[i] && r.mimeTypes[i].enabledPlugin)) { o = true } } else if (typeof s.ActiveXObject !== "undefined") { try { var h = new ActiveXObject(a); if (h) { var l = h.GetVariable("$version"); if (l) o = true } } catch (e) {} }
            return o
        },
        getSWFHTML: function() {
            var t = "",
