...
<center>
	<%if(session.getAttribute("name")!=null){ %>
        <a>欢迎你，用户<%=session.getAttribute("name")%></a>
        <a href="Logout">登出</a>
    <%} %>
<table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
					...
					<dl>
						<dt>
								...
								<dd><a>产地：<c:out value="${item.city}"></c:out></a></dd> 
 								...
 								<a href="Shopping?id=<c:out value="${item.id}"></c:out>&action=add"><img src="images/in_cart.png" onclick="myFunction(<c:out value="${item.id}"></c:out>)"></a> 
		...
		<div><a href="cart.jsp"><img alt="查看购物车" src="image/Lcart.jpg"></a></div>
		</center>
</body>
</html>